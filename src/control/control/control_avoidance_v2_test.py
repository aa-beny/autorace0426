    ...
    def scan_callback(self, msg):
        ...
        if 0 <= index_minus178 < len(msg.ranges) and 0 <= index_minus170 < len(msg.ranges):
            ...
            if obstacle_detected_minus10_to_10:
                ...
                # self.move_and_sleep(0.0, 0.0, 1.1)   # linear_speed, angular_speed, duration
                # self.move_and_sleep(0.0, 0.0, 1.0) 
                self.move_and_sleep(0.0, 0.0, 0.1)#停

                self.move_and_sleep(0.1, 3.4, 0.6)#左
                self.move_and_sleep(0.2, 0.0, 1.2)#直
                self.move_and_sleep(0.1, -2.75, 0.7)#右
                self.move_and_sleep(0.2, 0.0, 1.7)#直
                self.move_and_sleep(0.1, -2.4, 0.5)#右
                self.move_and_sleep(0.2, 0.0, 1.4)#直
                self.move_and_sleep(0.1, 2.4, 0.5)#左
                self.move_and_sleep(0.2, 0.0, 1.3)#直
                ...
                # self.move_and_sleep(0.1, -2.75, 0.7)#右
                # self.move_and_sleep(0.2, 0.0, 1.7)#直
                # self.move_and_sleep(0.1, -3.4, 0.5)#右
                # self.move_and_sleep(0.2, 0.0, 1.4)#直
                # self.move_and_sleep(0.1, 3.4, 0.5)#右
                # self.move_and_sleep(0.2, 0.0, 1.7)#直
                # self.move_and_sleep(0.1, 3.4, 0.6)#右
                # self.move_and_sleep(0.2, 0.0, 1.2)#直
                # self.move_and_sleep(0.1, -2.75, 0.7)#右
                # self.move_and_sleep(0.2, 0.0, 2.5)#直
